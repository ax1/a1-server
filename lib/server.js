...
function setLogger(customConfiguration) {
  if (process.env.SERVER_PERFORMANCE) configuration.Logger.configure(Logger.NoOutputLogger)
  ...
  if (customConfiguration.Logger === Logger.NoOutputLogger) process.env.SERVER_NO_LOG = "true"
}
