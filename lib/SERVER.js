(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("http"), require("https"), require("path"), require("url"), require("fs"), require("util"), require("crypto"), require("events"));
	else if(typeof define === 'function' && define.amd)
		define(["http", "https", "path", "url", "fs", "util", "crypto", "events"], factory);
	else if(typeof exports === 'object')
		exports["SERVER"] = factory(require("http"), require("https"), require("path"), require("url"), require("fs"), require("util"), require("crypto"), require("events"));
	else
		root["SERVER"] = factory(root["http"], root["https"], root["path"], root["url"], root["fs"], root["util"], root["crypto"], root["events"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_14__, __WEBPACK_EXTERNAL_MODULE_24__, __WEBPACK_EXTERNAL_MODULE_25__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	let http = __webpack_require__(1)
	let https = __webpack_require__(2)
	let path = __webpack_require__(3)
	let url = __webpack_require__(4)
	let fs = __webpack_require__(5)
	let router = __webpack_require__(6)
	let plugins = __webpack_require__(9)
	let proxy = __webpack_require__(10)//reverse proxy
	let security=__webpack_require__(21)
	 ...
	 * @return {Promise}
	 */
	function start(customConfiguration){
	  return new Promise(function(resolve, reject){
	    try{
	      ...
	      server.on('request', function(request, response) {
	        request.on('error', function(request, response) {
	          console.log('---------pasa por error')
	          //TODO throw 500 response
	        })
	        let route=getRoute(request)
	        if(isStaticPage(route.path)){
	          //static (dumb) file, send without executing plugins
	          dispatchContent(null,route,request,response)
	        }else{
	          //execute plugins and the process request
	          executePlugins(route,request,response,dispatchContent)
	        }
	      })
	...
	function executePlugins(route,request,response,callback){
	    plugins.executePlugins(route,request,response,callback)
	}

	function dispatchContent(err,route,request,response){
	  if (err) {
	    console.error(err)
	    dynamicPage('500',request, response)
	  } else{
	    try {
	      ...
	      if (isProxyPage(realPath,request)){
	        ...
	        if(request.method==='POST'  || request.method==='PUT' || request.method==='DELETE'){
	          ...
	          request.on('data', function(data) {
	            body=body+data
	            if (body.length>100) security.block(request)
	          })
	          request.on('end', function() {
	            this.body=body
	            dynamicPage(realPath,route.params,request, response)
	          })
	        }else{
	            dynamicPage(realPath,route.params,request, response)
	        }
	      }else{
	        staticPage(realPath,request, response)
	      }
	    } catch (e) {
	      console.error(err)
	      dynamicPage('500',request, response)
	 ...
	 */
	function staticPage(page,request, response){
	...
	*/
	function dynamicPage(page,paramsREST,request,response){
	  let resource=page
	  ...
	  try{
	    ...
	    if (fs.existsSync(fullResourcePath)===false){
	      return staticPage(page+'.html',request, response) // server/test=server/test.html
	    ...
	    let service=require(fullResourcePath)
			...
			let prepareOutput=function(request,response){
	      let closure=function(err,data){
	        try{
	          if (err) throw err
	          if (!data){
	            response.write('')
	          ...
	          console.log(err)
	          if (isNaN(err))response.writeHead(500)
	          else response.writeHead(err)
	        }finally{
	          response.end()
	        }
	      }
	    ...
	    let callback=prepareOutput(request,response);
	    switch(request.method.toLowerCase()){
	      case 'get':{
	        service.get(request,response,params,callback)
	        break;
	      }case 'post':{
	        service.post(request,response,params,callback)
	        break;
	      }case 'put':{
	        service.put(request,response,params,callback)
	        break;
	      }case 'delete':{
	        service.delete(request,response,params,callback)
	        break;
	      }default:{
	        //
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	let UrlPattern=__webpack_require__(7)
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  if (('function' === "function") && (__webpack_require__(8) != null)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	let url = __webpack_require__(4)
	let router = __webpack_require__(6)
	let http_proxy=__webpack_require__(11)
	...
	function configureProxy(){
	  ...
	  proxy.on('open', function (proxySocket) {
	    ...
	    proxySocket.on('data', function(){console.log('ha pasado por aquí')});
	  });
	...
	function proxyPage(page,request,response,stop){
	  ...
	  proxy.web(request, response, {target: externalAddr,ignorePath: true})
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var http      = __webpack_require__(1),
	    https     = __webpack_require__(2),
	    url       = __webpack_require__(4),
	    httpProxy = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var httpProxy = module.exports,
	    ...
	    parse_url = __webpack_require__(4).parse,
	    EE3       = __webpack_require__(15),
	    http      = __webpack_require__(1),
	    https     = __webpack_require__(2),
	    web       = __webpack_require__(16),
	    ws        = __webpack_require__(20);
	...
	__webpack_require__(14).inherits(ProxyServer, EE3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var http   = __webpack_require__(1),
	    https  = __webpack_require__(2),
	    web_o  = __webpack_require__(17),
	    common = __webpack_require__(18),
	    passes = exports;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var common   = exports,
	    url      = __webpack_require__(4),
	    extend   = __webpack_require__(14)._extend,
	    required = __webpack_require__(19);
...
/***/ function(module, exports) {
	...
	function block(request){
	  blacklist.push(getClient(request))
	  request.destroy()
	}
...
/***/ function(module, exports, __webpack_require__) {
		...
		*/
		function dynamicPage(page,paramsREST,request,response){
		  ...
		  try{
		    ...
		    let service=__webpack_require__(22)(fullResourcePath)
		    let prepareOutput=function(request,response){
		      let closure=function(err,data){
		        try{
		          if (err) throw err
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		*/
		...
		},{"./router":3,"http-proxy":6,"url":undefined}],3:[function(require,module,exports){
		...
		},{"url-pattern":8}],4:[function(require,module,exports){
		/**
		 * Protect the server against attacks
		 */
		...
		*/
		...
		},{"./plugins":1,"./proxy-external":2,"./router":3,"./security":4,"fs":undefined,"http":undefined,"https":undefined,"path":undefined,"url":undefined}],6:[function(require,module,exports){
		/*!
		 * Caron dimonio, con occhi di bragia
		 * loro accennando, tutte le raccoglie;
		 * batte col remo qualunque s’adagia
		...
		},{"./lib/http-proxy":7}],7:[function(require,module,exports){
		...
		},{"./http-proxy/":7,"http":undefined,"https":undefined,"url":undefined}],8:[function(require,module,exports){
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		let Nedb = __webpack_require__(25)
		let database
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var Datastore = __webpack_require__(26);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		util.inherits(Datastore, __webpack_require__(42).EventEmitter);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var async = __webpack_require__(31)
		  ;
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var BinarySearchTree = __webpack_require__(34).AVLTree
		  , model = __webpack_require__(29)
		  , _ = __webpack_require__(30)
		  , util = __webpack_require__(14)
		  ;
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		module.exports.BinarySearchTree = __webpack_require__(35);
		module.exports.AVLTree = __webpack_require__(37);
	...
	/***/ function(module, exports, __webpack_require__) {
		 ...
		 */
		var customUtils = __webpack_require__(36);
	...
	/***/ function(module, exports, __webpack_require__) {
		 ...
		 */
		var BinarySearchTree = __webpack_require__(35)
		  , customUtils = __webpack_require__(36)
		  , util = __webpack_require__(14)
		  , _ = __webpack_require__(30)
		  ;
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var storage = __webpack_require__(39)
		  ...
		  , model = __webpack_require__(29)
		  , async = __webpack_require__(31)
		  , customUtils = __webpack_require__(27)
		  , Index = __webpack_require__(33)
		  ;
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		function proxyPage(page,request,response,stop){
		  ...
		  let options = {
		    host: target.host,/*http 1.1*/
		    hostname:target.hostname,port:target.port, /*http 1.0*/
		    path: target.path, method: request.method, headers: headers
		  }

		  let req=http.request(options,function(res){
		    //res.setEncoding('utf8')
		    res.on('data', (chunk) => {
		      if (stop || (res.statusCode!==301 && res.statusCode!==302)){response.write(chunk)}
		    })
		    res.on('end', () => {
...
/***/ function(module, exports, __webpack_require__) {
	...
	let Nedb = __webpack_require__(27)
	let database
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Datastore = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var customUtils = __webpack_require__(29)
	  , model = __webpack_require__(30)
	  , async = __webpack_require__(32)
	  , Executor = __webpack_require__(33)
	  , Index = __webpack_require__(34)
	  , util = __webpack_require__(14)
	  , _ = __webpack_require__(31)
	  , Persistence = __webpack_require__(39)
	...
	util.inherits(Datastore, __webpack_require__(25).EventEmitter);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BinarySearchTree = __webpack_require__(35).AVLTree
	  , model = __webpack_require__(30)
	  , _ = __webpack_require__(31)
	  , util = __webpack_require__(14)
	  ;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.BinarySearchTree = __webpack_require__(36);
	module.exports.AVLTree = __webpack_require__(38);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Simple binary search tree
	 */
	var customUtils = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Self-balancing binary search tree using the AVL implementation
	 */
	var BinarySearchTree = __webpack_require__(36)
	  , customUtils = __webpack_require__(37)
	  , util = __webpack_require__(14)
	  , _ = __webpack_require__(31)
	  ;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var storage = __webpack_require__(40)
	  ...
	  , model = __webpack_require__(30)
	  , async = __webpack_require__(32)
	  , customUtils = __webpack_require__(29)
	  , Index = __webpack_require__(34)
	  ;
