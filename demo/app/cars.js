...
const db={
  "doKnnvbRCpt7fQaC":{name:"toyota",engine:"2222",id:"doKnnvbRCpt7fQaC"},
  "tibP9rhyyu3dzTtX":{name:"toyota",engine:"1111",id:"tibP9rhyyu3dzTtX"}
}
...
async function remove(request,response,params){
  if(params){
    if (db[params.id]){delete db[params.id];return 1}
    else throw (404)
  }else{
    throw(400)
  }
